...
@interface MiOPresentTransition ()
...
@implementation MiOPresentTransition
...
//    HXPhotoView *photoView;
    ...
    MiOPhotoSubViewCell *cell = (MiOPhotoSubViewCell *)[collectionView cellForItemAtIndexPath:self.photoView.currentIndexPath];
    ...
    MiOPhotoModel *model = cell.model;
...
- (void)dismissAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    MiOPhotoSubViewCell *cell = (MiOPhotoSubViewCell *)[collectionView cellForItemAtIndexPath:[NSIndexPath indexPathForItem:model.endCollectionIndex inSection:0]];
