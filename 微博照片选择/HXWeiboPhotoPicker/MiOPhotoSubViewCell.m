...
@interface MiOPhotoSubViewCell ()<UIAlertViewDelegate>
...
@implementation MiOPhotoSubViewCell
...
- (UIButton *)deleteBtn {
    if (!_deleteBtn) {
        ...
        [_deleteBtn setImage:[MiOPhohoTools hx_imageNamed:@"compose_delete@2x.png"] forState:UIControlStateNormal];
...
- (UIImageView *)liveIcon {
    if (!_liveIcon) {
        _liveIcon = [[UIImageView alloc] initWithImage:[MiOPhohoTools hx_imageNamed:@"compose_live_photo_open_only_icon@2x.png"]];
...
- (UIImageView *)videoIcon {
    if (!_videoIcon) {
        _videoIcon = [[UIImageView alloc] initWithImage:[MiOPhohoTools hx_imageNamed:@"VideoSendIcon@2x.png"]];
    }
    return _videoIcon;
}
- (UILabel *)videoTime {
...
- (UIImageView *)gifIcon {
    if (!_gifIcon) {
        _gifIcon = [[UIImageView alloc] initWithImage:[MiOPhohoTools hx_imageNamed:@"timeline_image_gif@2x.png"]];
    }
    return _gifIcon;
}
- (MiOCircleProgressView *)progressView {
    if (!_progressView) {
        _progressView = [[MiOCircleProgressView alloc] init];
