//
//  MiOFullScreenCameraViewController.m
//  微博照片选择
//
...
#import "MiOFullScreenCameraPlayView.h"
#import "MiOPhotoManager.h"
#import "MiOPhotoEditViewController.h"
#define WIDTH [UIScreen mainScreen].bounds.size.width
#define HEIGHT [UIScreen mainScreen].bounds.size.height

@interface MiOFullScreenCameraViewController ()<UIGestureRecognizerDelegate,AVCaptureFileOutputRecordingDelegate,UIViewControllerTransitioningDelegate,HXPhotoEditViewControllerDelegate>
...
@property (strong, nonatomic) MiOFullScreenCameraPlayView *playView;
...
@implementation MiOFullScreenCameraViewController
- (instancetype)init {
    self = [super init];
    if (self) {
...
//        navItem.rightBarButtonItems = @[rightOne_];
    ...
    UIImageView *topMaskView = [[UIImageView alloc] initWithImage:[MiOPhohoTools hx_imageNamed:@"camera_shadow_up@2x.png"]];
    ...
    UIImageView *bottomMaskView = [[UIImageView alloc] initWithImage:[MiOPhohoTools hx_imageNamed:@"camera_shadow_down@2x.png"]];
    ...
    [backBtn setImage:[MiOPhohoTools hx_imageNamed:@"faceu_cancel@3x.png"] forState:UIControlStateNormal];
    ...
    [changeCameraBtn setImage:[MiOPhohoTools hx_imageNamed:@"faceu_camera@3x.png"] forState:UIControlStateNormal];
    ...
    [self.flashBtn setImage:[MiOPhohoTools hx_imageNamed:@"camera_flashlight@2x的副本11.png"] forState:UIControlStateNormal];
    [self.flashBtn setImage:[MiOPhohoTools hx_imageNamed:@"flash_pic_nopreview@2x.png"] forState:UIControlStateSelected];
    ...
    self.playView = [[MiOFullScreenCameraPlayView alloc] initWithFrame:CGRectMake(0, HEIGHT - 20 - 70, 70, 70)];
...
- (void)didBackClick {
    if (!self.backBtn.selected) {
        ...
        [self.backBtn setImage:[MiOPhohoTools hx_imageNamed:@"faceu_cancel@3x.png"] forState:UIControlStateNormal];
...
- (void)hideClick {
    ...
    self.backBtn.hx_w = [MiOPhohoTools getTextWidth:self.backBtn.currentTitle withHeight:18 fontSize:17] + 20;
...
- (void)didNextBtnClick {
    ...
    if (!self.videoURL) {
        ...
        NSString *videoTime = [MiOPhohoTools getNewTimeFromDurationSecond:self.videoTime];
