...
#import "MiOVideoPresentTransition.h"
#import "MiOCameraPreviewViewController.h"
#import "MiOPhotoManager.h"
#import "MiOPhotoEditViewController.h"
@interface MiOCameraViewController ()<UIGestureRecognizerDelegate,AVCaptureFileOutputRecordingDelegate,UIViewControllerTransitioningDelegate,HXPhotoEditViewControllerDelegate>
...
@implementation MiOCameraViewController
...
- (void)cameraDistrict
{
    ...
    [leftBtn setImage:[MiOPhohoTools hx_imageNamed:@"camera_close@2x.png"] forState:UIControlStateNormal];
    [leftBtn setImage:[MiOPhohoTools hx_imageNamed:@"camera_close_highlighted@2x.png"] forState:UIControlStateHighlighted];
    ...
    [rightOne setImage:[MiOPhohoTools hx_imageNamed:@"camera_overturn@2x.png"] forState:UIControlStateNormal];
    [rightOne setImage:[MiOPhohoTools hx_imageNamed:@"camera_overturn_highlighted@2x.png"] forState:UIControlStateHighlighted];
    ...
    [rightTwo setImage:[MiOPhohoTools hx_imageNamed:@"camera_flashlight_auto_disable@2x.png"] forState:UIControlStateNormal];
    ...
    [photoBtn setImage:[MiOPhohoTools hx_imageNamed:@"camera_camera_background@2x.png"] forState:UIControlStateNormal];
    [photoBtn setImage:[MiOPhohoTools hx_imageNamed:@"camera_camera_background_highlighted@2x.png"] forState:UIControlStateHighlighted];
    ...
    [videoBtn setImage:[MiOPhohoTools hx_imageNamed:@"camera_video_background@2x.png"] forState:UIControlStateNormal];
    ...
    UIImageView *centerIcon = [[UIImageView alloc] initWithImage:[MiOPhohoTools hx_imageNamed:@"camera_drop_highlighted@2x.png"]];
...
//    [self.backView addSubview:self.zoomSlider];
    ...
    self.focusIcon = [[UIImageView alloc] initWithImage:[MiOPhohoTools hx_imageNamed:@"camera_ Focusing@2x.png"]];
...
- (void)didLongClick:(UILongPressGestureRecognizer *)longRPG
{
    if ([longRPG state] == UIGestureRecognizerStateBegan) {
        [self.videoBtn setImage:[MiOPhohoTools hx_imageNamed:@"camera_video_background_highlighted@2x.png"] forState:UIControlStateNormal];
        [self cameraBackgroundDidClickPlay];
    }else if ([longRPG state] == UIGestureRecognizerStateEnded) {
        [self.videoBtn setImage:[MiOPhohoTools hx_imageNamed:@"camera_video_background@2x.png"] forState:UIControlStateNormal];
...
- (void)didRightTwoClick
{
    ...
    if ([self.device hasFlash]) {
        if (self.flashlight == 0) {
            self.flashlight = 1;
            [self.rightTwo setImage:[MiOPhohoTools hx_imageNamed:@"camera_flashlight_disable@2x.png"] forState:UIControlStateNormal];
            self.device.flashMode = AVCaptureFlashModeOff;
        }else if (self.flashlight == 1){
            self.flashlight = 1;
            [self.rightTwo setImage:[MiOPhohoTools hx_imageNamed:@"camera_flashlight_open_disable@2x.png"] forState:UIControlStateNormal];
            self.device.flashMode = AVCaptureFlashModeOn;
            self.flashlight = 2;
        }else {
            self.flashlight = 0;
            [self.rightTwo setImage:[MiOPhohoTools hx_imageNamed:@"camera_flashlight_auto_disable@2x.png"] forState:UIControlStateNormal];
...
- (UIButton *)deleteBtn
{
    if (!_deleteBtn) {
        ...
        [_deleteBtn setImage:[MiOPhohoTools hx_imageNamed:@"video_delete_dustbin@2x.png"] forState:UIControlStateNormal];
...
- (UIButton *)nextBtn
{
    if (!_nextBtn) {
        ...
        _nextBtn.hidden = YES;
        [_nextBtn setImage:[MiOPhohoTools hx_imageNamed:@"video_next_button@2x.png"] forState:UIControlStateNormal];
        [_nextBtn setImage:[MiOPhohoTools hx_imageNamed:@"video_next_button_highlighted@2x.png"] forState:UIControlStateHighlighted];
...
- (void)nextClick
{
    ...
    if (self.changePhotoBtn.selected) {
        ...
        [self clipVideoCompleted:^{
            ...
            NSString *videoTime = [MiOPhohoTools getNewTimeFromDurationSecond:weakSelf.videoTime];
...
- (id<UIViewControllerAnimatedTransitioning>)animationControllerForPresentedController:(UIViewController *)presented presentingController:(UIViewController *)presenting sourceController:(UIViewController *)source{
    return [MiOVideoPresentTransition transitionWithTransitionType:HXVideoPresentTransitionPresent];
}

- (id<UIViewControllerAnimatedTransitioning>)animationControllerForDismissedController:(UIViewController *)dismissed{
    return [MiOVideoPresentTransition transitionWithTransitionType:HXVideoPresentTransitionDismiss];
}
- (void)dealloc { 
    NSSLog(@"dealloc");
}
