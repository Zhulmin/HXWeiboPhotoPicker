...
@interface MiOPhotoViewController : UIViewController
@property (strong, nonatomic) MiOPhotoManager *manager; // 照片管理类必须在跳转前赋值
...
@property (strong, nonatomic, readonly) MiOAlbumModel *albumModel;
