...
{
    CGFloat hudW = [MiOPhohoTools getTextWidth:text withHeight:15 fontSize:14];
    if (hudW > self.frame.size.width - 60) {
        hudW = self.frame.size.width - 60;
    }
    CGFloat hudH = [MiOPhohoTools getTextHeight:text withHeight:hudW fontSize:14];
...
- (void)setup
{
    UIImageView *imageView = [[UIImageView alloc] initWithImage:[MiOPhohoTools hx_imageNamed:self.imageName]];
    ...
    CGFloat labelH = [MiOPhohoTools getTextHeight:self.text withHeight:labelW fontSize:14];
