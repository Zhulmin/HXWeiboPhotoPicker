...
- (void)prefetchThumbImage {
    ...
    self.requestID = [MiOPhohoTools getHighQualityFormatPhotoForPHAsset:self.asset size:self.requestSize completion:^(UIImage *image, NSDictionary *info) {
