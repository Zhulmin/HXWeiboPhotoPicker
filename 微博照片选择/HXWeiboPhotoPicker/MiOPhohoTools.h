...
#import "NSBundle+MiOWeiboPhotoPicker.h"
#ifdef DEBUG
...
@interface MiOPhohoTools : NSObject
 ...
 */
+ (void)getImageForSelectedPhoto:(NSArray<MiOPhotoModel *> *)photos type:(HXPhotoToolsFetchType)type completion:(void(^)(NSArray<UIImage *> *images))completion;
